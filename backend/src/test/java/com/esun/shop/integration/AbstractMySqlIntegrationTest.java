 ...
 * 07_shipping_address.sql -> 08_shopping_cart.sql -> 09_product_review.sql -> 10_product_management.sql -> 11_order_status.sql -> 12_audit_log.sql -> 13_payment.sql scripts (the same files
...
abstract class AbstractMySqlIntegrationTest {
    ...
    static final MySQLContainer<?> MYSQL = new MySQLContainer<>(DockerImageName.parse("mysql:8.0"))
            ...
            .withCopyFileToContainer(
                    MountableFile.forHostPath("DB/12_audit_log.sql"),
                    "/docker-entrypoint-initdb.d/12_audit_log.sql")
            .withCopyFileToContainer(
                    MountableFile.forHostPath("DB/13_payment.sql"),
